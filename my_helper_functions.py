...
def get_class_f1_scores(y_labels, class_names, pred_classes):
    ...
    Args:
        ...
        class_names : names of the classes in dataset
...
def plot_f1_scores(class_f1_scores):
    ...
    Returns:
        Plots a bar plot compairing different f1-scores.
    """

    # Converting dictionary into Pandas Dataframe foreay visualization
    ...
    ax.set_title("F1 Scores for the Test Data")
    ax.invert_yaxis()
...
def pred_and_plot(model, filename, class_names):
    ...
    img = load_and_prep_image(filename, scale)
